...
class DigipowerHumiditySensor(CoordinatorEntity, SensorEntity):
    ...
    def __init__(self, coordinator: DataUpdateCoordinator, entry_id: str, device: DigipowerPDU):
        ...
        self.entity_id = "{}_humidity".format(device.devicename.lower().replace(" ",""))
        self._device = device
        self._state = None
...
class DigipowerTemperatureSensor(CoordinatorEntity, SensorEntity):
    ...
    def __init__(self, coordinator: DataUpdateCoordinator, entry_id: str, device: DigipowerPDU):
        ...
        self.entity_id = "{}_temperature".format(device.devicename.lower().replace(" ",""))
        self._device = device
        self._state = None
...
class DigipowerCurrentSensor(CoordinatorEntity, SensorEntity):
    ...
    def __init__(self, coordinator: DataUpdateCoordinator, entry_id: str, device: DigipowerPDU):
        ...
        self.entity_id = "{}_current".format(device.devicename.lower().replace(" ",""))
        self._device = device
        self._state = None
